import { Repository, SelectQueryBuilder, ObjectLiteral, FindConditions, FindOneOptions } from 'typeorm';
import { Pagination } from './pagination';
import { IPaginationMeta, IPaginationOptions } from './interfaces';
export declare function paginate<T, CustomMetaType = IPaginationMeta>(repository: Repository<T>, options: IPaginationOptions<CustomMetaType>, searchOptions?: FindConditions<T> | FindOneOptions<T>): Promise<Pagination<T, CustomMetaType>>;
